...
function fnLoadGlossaryPopupPage(aCurrent) {
    ...
    //console.log(_getDesc);
    var __html = '<div class="popupglossasryCnt"><div id="helptopbar"><div id="id_glosTitleText" class="titleCase">' + _getHeading + '</div><div class="close_txt"><span id="clsText">Close</span></div><div id="id_glosCloseBtn" class="id_glosCloseBtn" title="Close"></div></div><div class="glossaryCntTxt">' + _getDesc + '</div></div>';
    ...
    switch (lCase) {
        ...
        case "NEXT":
            ...
            if (_getPreviousBookMarkPage != "") {
                ...
                if (lPageId == "M1L0T1P16") {
                    if (__alreadyVisitedFourIcon == 1) {
                        __alreadyVisitedFourIcon = 2;

                    }
                    var allSubPageVisited = true;
                    for (var i = 0; i < oral_tube_MenuArr.length; i++) {
                        if (gCompPageArr.indexOf(oral_tube_MenuArr[i]) == -1) {
                            allSubPageVisited = false;
                            console.log("value false--------------------" + allSubPageVisited)
                            break;
                        }
                    }
                    console.log(allSubPageVisited + "--rishi")
                    if (allSubPageVisited) {
                        fnJumpToPageByID("M1L0T1P16_10");
                        return;
                    }

                    if (gCompPageArr.indexOf("M1L0T1P16_1") == -1) {
                        fnJumpToPageByID("M1L0T1P16_1");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P16_2") == -1) {
                        fnJumpToPageByID("M1L0T1P16_2");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P16_3") == -1) {
                        fnJumpToPageByID("M1L0T1P16_3");
                        return;
                    }
                    if (gCompPageArr.indexOf("M1L0T1P16_4") == -1) {
                        fnJumpToPageByID("M1L0T1P16_4");
                        return;
                    }


                }
                if (lPageId == "M1L0T1P14") {
                    __alreadyVisitedBaby = true;
                }

                if (lPageId == "M1L0T1P16_1" || lPageId == "M1L0T1P16_2" || lPageId == "M1L0T1P16_3" || lPageId == "M1L0T1P16_4" || lPageId == "M1L0T1P16_9") {
        ...
        case "PREV":
            ...
            if (currPageId == "M1L0T1P8" || currPageId == "M1L0T1P14" || currPageId == "M1L0T1P15") {
            ...
            */
            ...
            } else if (currPageId == "M1L0T1P16_4") {

                fnJumpToPageByID("M1L0T1P16");

            } else if (currPageId == "M1L0T1P3") {

                console.log(__curConCordVisit + ":::" + __curMateoVisit)

                if (__curConCordVisit == 1 && __curMateoVisit == 1) {
            ...
            if (currPageId == "M1L0T1P91") {
                fnJumpToPageByID("M1L0T1P82_1");
...
function fnSoundOnOff() {
    ...
    if (!bAudioMute) {
        ...
        $("#clsAudioOnBtn").css("display", "none");
        $("#clsAudioOffBtn").css("display", "inline");
        $("#clsAudioOffBtn span.tooltip").html("UnMute");
        isAudioEnable = false;
    } else {
        audioObjRef.muted = false;
        $("#clsAudioOffBtn").css("display", "none");
        $("#clsAudioOnBtn").css("display", "inline");
        $("#clsAudioOffBtn span.tooltip").html("Mute");
        isAudioEnable = true;
    }
