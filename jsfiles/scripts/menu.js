                ...
                //for(var k=0;k<gModuleArr[i].Lessons[j].Topics.length;k++)
                {
                    ...
                    for (var l = 0; l < gModuleArr[i].Lessons[j].Topics[k].Pages.length; l++) {
                        ...
                        if (gCurrPage == l && gCurrTop == k && gCurrLess == j && gCurrMod == i) {
                            ...
                            //for current page
                            //if completed
                            //console.log("ooooo "+gModuleArr[i].Lessons[j].Topics[k].isCompleted)
                            //if(fCheckCompletion(gModuleArr[i].Lessons[j].Topics[k].Pages[l],"Page")){
                            //if(gModuleArr[i].Lessons[j].Topics[k].Pages[l].isCompleted == "1"){
                            //console.log(fCheckCompletion(gModuleArr[i].Lessons[j].Topics[k].Pages[l], "Page"));
                            if (fCheckCompletion(gModuleArr[i].Lessons[j].Topics[k].Pages[l], "Page")) {
                                //console.log(lPgId)
                                ...
                                menuStr += '<li id="selected" class="pageSelected currentPage" pageId="' + lPgId + '"><a  class="forSelection" >' + mImg + '<div class="pageStyle pageSelectedStyle" style="position:relative; cursor: default;"><div id="' + lPgId + '" style="font-size: 82.23%;cursor: default;font-family:OpenSansRegular;" class=' + tempClass + '>' + gModuleArr[i].Lessons[j].Topics[k].Pages[l].find('PAGETITLE').text() + '</div></div><div class="' + pageStatus + '"></div></a>'
                            } else {
                            ...
                            if (fCheckCompletion(gModuleArr[i].Lessons[j].Topics[k].Pages[l], "Page")) {
                                ...
                                menuStr += '<li class="pageNormal completedPage CLSSVISITED" style="opacity:1;" id="' + lPgId + '" pageId="' + lPgId + '"  onclick="javascript:fnOnMenuItemClick(\'' + lPgId + '\',true);"><a id="visited" class="forSelection" style="cursor:pointer;">' + mImg + '<div class="pageStyle" style="position:relative; cursor:pointer;"><div style="font-size: 82.23%; cursor:pointer;font-family:OpenSansRegular;" class=' + tempClass + '>' + gModuleArr[i].Lessons[j].Topics[k].Pages[l].find('PAGETITLE').text() + '</div></div><div class="' + pageStatus + '"></div></a>'
                            } else {
                                //for lock page
                                ...
                                if (closedNavigation == "true") {
                                    ...
                                    var tickMark = "<div class='menuTickmarkSymbol' style='opacity:1;'></div>"
                                        //lock page
                                    menuStr += '<li class="pageNormal" id="' + lPgId + '" pageId="' + lPgId + '"  onclick="javascript:fnOnMenuItemClick(\'' + lPgId + '\',true);"><a id="visited" class="forSelection lockHover" style="cursor:default;">' + mImg + '<div class="pageStyle" style="position:relative; cursor:default;"><div style="font-size: 82.23%;font-family:OpenSansRegular;" class=' + tempClass + '>' + gModuleArr[i].Lessons[j].Topics[k].Pages[l].find('PAGETITLE').text() + '</div></div><div class="' + pageStatus + '"></div></a>'
                                    ...
                                    var tickMark = "<div class='menuTickmarkSymbol' style='opacity:1;'></div>"
                                        //for open page
                                    menuStr += '<li class="pageNormal CLSSVISITED" style="opacity:1;" id="' + lPgId + '" pageId="' + lPgId + '"  onclick="javascript:fnOnMenuItemClick(\'' + lPgId + '\',true);"><a id="visited" class="forSelection" style="cursor:pointer;">' + mImg + '<div class="pageStyle" style="position:relative; cursor:pointer;"><div style="font-size: 82.23%; font-family:OpenSansRegular; cursor: inherit;" class=' + tempClass + '>' + gModuleArr[i].Lessons[j].Topics[k].Pages[l].find('PAGETITLE').text() + '</div></div></a>'
