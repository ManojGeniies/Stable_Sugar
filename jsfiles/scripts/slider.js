...
function fnProgressBar() {
    ...
    $("#slider").slider({
        ...
        slide: function (event, ui) {
            ...
            playerWidth = $(".player-container").width() * scalePercent;

            nMargin = ($(window).width() - playerWidth) / 2;

            mouseClick = event.pageX - nMargin;

            sliderComplete = mouseClick - ($("#id_sliderContainer").position().left);

            totalSliderWid = $("#id_sliderContainer").width() * scalePercent;
            ...
            //adjust the masterTimeline's progress() based on slider value
