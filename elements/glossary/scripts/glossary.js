...
function Glossary() {
    ...
    var __onMedNameClick = function(aEvent) {
        ...
        if ($(aEvent.currentTarget).attr('audioSource') !="") {
            //console.log($(aEvent.currentTarget).attr("audioSource"));
            //__$cMedDescContainer.attr("id",);
            _curAttr = $(aEvent.currentTarget).attr("audioSource");
            __$cDescMedNameContainer.attr("id",_curAttr);
        }
