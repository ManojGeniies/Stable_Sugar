manifest = [
    ...
    { src: 'pages/images/Topic01/T01P58/img1.png', id: '1' },

    { src: 'pages/images/Topic01/T01P58/image_01_small.png', id: '2' },

];


var audioPath = "pages/audio/Topic01/T01P58/T01P58";

var gItemAudioPath = ["pages/audio/Topic01/T01P58/T01P58_1",

    "pages/audio/Topic01/T01P58/T01P58_3",
...
var updateContentArray = [

    {
        ...
        show: "",
        hide: "",
        transcript: "Baby Mateo's blood sugar 30 minutes after the infusion of 3.5 mL of D10W is 58 milligrams per deciliter. Which physician orders are most appropriate in this situation? Select all that apply and click Submit."
    },
    {
        time: "8.0",
        carry: "",
...
$(document).ready(function() {
    ...
    var n = isInArray("M1L0T1P58", gCompPageArr);
...
function submitClick(aCurrent) {
    if (aCurrent.hasClass("active")) {
        ...
        tinCanWrapper.sendStatementData("answered", "Baby-Mateo's-blood-sugar-30-minutes-after-the-infusion-of-3.5-mL...", "Baby Mateo's blood sugar 30 minutes after the infusion of 3.5 mL of D. W is 58 mg/dL (3.2 mmol/L). Which physician orders are most appropriate in this situation?");
        ...
        $(".feedback_icon").off("click").on("click", function() {
            ...
            if (__ficon == "1") {
                _getDesc = "Decreasing the IV rate will decrease the glucose infusion rate and will likely result in reoccurence of hypoglycemia.";
                _getHeading = "Decrease the D<sub>10</sub>W IV infusion rate to 4.4 mL per hour";

            } else if (__ficon == "3") {
                _getDesc = "Another glucose bolus is not indicated when the blood sugar value is above 50 mg/dL.";
                _getHeading = "Repeat D<sub>10</sub>W 3.5 mL IV over 4 minutes";
            } else if (__ficon == "4") {
                _getDesc = "Confirmatory testing is usually only required when there is uncertainty about the accuracy of the bedside glucose screening test.";
                _getHeading = "Send a confirmatory plasma glucose sample to the lab";
            }
